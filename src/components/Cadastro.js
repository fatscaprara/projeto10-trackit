...
export default function Cadastro() {
  ...
  const [dadosContaNova, setDadosContaNova] = useState({
    email: "",
    name: "",
    image: "",
    password: "",
        ...
        {carregandoCadastro === false ? (
          <form onSubmit={cadastrarConta}>
            <input
              ...
              onChange={(e) =>
                setDadosContaNova({ ...dadosContaNova, email: e.target.value })
              }
              nome="email"
              id="email"
              placeholder="email"
            ...
            <input
              ...
              onChange={(e) =>
                setDadosContaNova({ ...dadosContaNova, name: e.target.value })
              }
              nome="nome"
              id="nome"
              placeholder="nome"
            ...
            <input
              ...
              onChange={(e) =>
                setDadosContaNova({ ...dadosContaNova, image: e.target.value })
              }
              nome="foto"
              id="foto"
              placeholder="foto"
