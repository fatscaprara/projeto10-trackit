      ...
      return (
        <>
            ...
            carregandoHabitoNovo === false ? (
              <JanelaAdicionarHabito onSubmit={enviarHabito}>
                <input
                  ...
                  onChange={(e) =>
                    setHabitoNovo({ ...habitoNovo, name: e.target.value })
                  }
                  nome="nome do hábito"
                  id="nome do hábito"
                  placeholder="nome do hábito"
                />
                <menu>{renderizarListaDiasDaSemana}</menu>
                <div>
                  <BotaoSalvar
                    type="submit"
                    onClick={() =>
                      setHabitoNovo({
                        ...habitoNovo,
                        days: habitoNovo.days.sort(),
                      })
                    }
                  >
                    Salvar
                  </BotaoSalvar>
                  <BotaoCancelar onClick={() => setAdicionarHabito(false)}>
                    Cancelar
                  </BotaoCancelar>
                </div>
          ...
          {listaHabitos.map((habito) => {
            ...
            return <HabitosLista key={id} id={id} nome={name} dias={days} />;
          })}
        </>
      );
    } else {
